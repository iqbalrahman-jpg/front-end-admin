    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-2">
            <button type="button" class="btn btn-success m-1"><a style="color: white;" href="/paket/tambah">Tambah Data</a></button>
          </div>
        </div></br>
        <div class="row">
              ...
              <div class="card-body p-4">
                ...
                <div class="table-responsive">
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                      <?php $i = 1; ?>
                      @foreach($data['paket_wisata'] as $p)
                      <tr>
                        <td class="border-bottom-0"><h6 class="fw-semibold mb-0">{{$i}}</h6></td>
                        <td class="border-bottom-0">
                          <p class="fw-semibold mb-1">{{ $p['paket_deskripsi'] }}</p>
                        </td>
                        <td class="border-bottom-0">
                          <p class="mb-0 fw-normal">Rp. {{ $p['harga'] }} /pax</p>
                        </td>
                        <td class="border-bottom-0">
                        ...
                        <td class="border-bottom-0">
                          <h6 class="fw-semibold mb-0 fs-4"><a href="/edit/{{ $p['_id'] }}">Edit</a></h6>
