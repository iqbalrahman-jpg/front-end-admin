          ...
          <div class="col d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Pesanan Member</h5>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0">
                          <p class="fw-semibold mb-1">{{ $p['nama'] }}</p>
                        </td>
                        <td class="border-bottom-0">
                          <p class="mb-0 fw-normal">{{ $p['email'] }}</p>
                        </td>
                        <td class="border-bottom-0">
                          <p class="mb-0 fw-normal">{{ $p['telp'] }}</p>
                        </td>
                        <td class="border-bottom-0">
                        ...
                        <td class="border-bottom-0">
                          <h6 class="fw-semibold mb-0 fs-4"><a href="transaksi-member/{{ $p['id'] }}">Lihat Detail</a></h6>
