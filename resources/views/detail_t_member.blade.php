      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link active" href="/transaksi-member" aria-expanded="false">
                <span>
                  <i class="ti ti-article"></i>
                </span>
                <span class="hide-menu">Member</span>
          ...
          <div class="col d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">{{$data['nama'][0][0]['nama']}}</h5>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                      <tr>
                        ...
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Harga /pax</h6>
                        </th>
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Total Biaya</h6>
                        </th>
                        <th class="border-bottom-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0">
                          <p class="fw-semibold mb-1">{{ $data['pesanan'][$a]['pax'] }}</p>
                        </td>
                        <td class="border-bottom-0">
                          <p class="fw-semibold mb-1">{{ $data['paket'][$a]['harga'] }}</p>
                        </td>
                        <td class="border-bottom-0">
                        ...
                        <td class="border-bottom-0">
                          <h6 class="fw-semibold mb-0 fs-4"><a href="/edit/{{ $data['pesanan'][$a]['id'] }}">Edit</a></h6>
                ...
                <button type="button" class="btn btn-warning m-1"><a style="color: white;" href="/transaksi-member">Kembali</a></button>
              </div>
            </div>
          </div>
        </div>
