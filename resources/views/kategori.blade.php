      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link active" href="/kategori" aria-expanded="false">
                <span>
                  <i class="ti ti-article"></i>
                </span>
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-2">
            <button type="button" class="btn btn-success m-1"><a style="color: white;" href="/kategori/tambah">Tambah Data</a></button>
          </div>
        </div></br>
        <div class="row">
          <div class="col d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Kategori Wisata</h5>
                <div class="table-responsive">
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                      <?php $i = 1; ?>
                      @foreach($data['kategori'] as $p)
                      <tr>
                        <td class="border-bottom-0"><h6 class="fw-semibold mb-0">{{$i}}</h6></td>
                        <td class="border-bottom-0">
                          <p class="fw-semibold mb-1">{{ $p['nama_kategori'] }}</p>
                        </td>
                        <td class="border-bottom-0">
                        ...
                        <td class="border-bottom-0">
                          <h6 class="fw-semibold mb-0 fs-4"><a href="/kategori/edit/{{ $p['_id'] }}">Edit</a> | <a href="/kategori/delete/{{ $p['_id'] }}" style="color: red;">Hapus</a></h6>
                        </td>
                      </tr>
                      <?php $i++; ?>
                      @endforeach              
