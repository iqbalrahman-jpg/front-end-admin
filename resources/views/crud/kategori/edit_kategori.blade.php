      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
                ...
                <div class="card-body">
                  <form action="/kategori/edit" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="nama_kategori" id="nama_kategori" value="<?= $data['kategori']['nama_kategori'] ?>" required>
                      <input type="hidden" class="form-control" name="id" id="id" value="<?= $data['kategori']['_id'] ?>" required>
                    </div>
                    <div class="mb-3">
                      <label for="status" class="form-label">Status</label><br>
                      <select name="status" id="status">
                        <?php if($data['kategori']['status'] == 0) { ?>
            ...
            <button type="button" class="btn btn-warning m-1"><a style="color: white;" href="/kategori">Kembali</a></button>
          </div>
        </div>
      </div>
    </div>
