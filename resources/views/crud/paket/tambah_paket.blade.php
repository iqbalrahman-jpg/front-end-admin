      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link active" href="/paket" aria-expanded="false">
                <span>
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Paket Wisata</h5>
              <div class="card">
                <div class="card-body">
                  <form action="<?php url('/paket/tambah') ?>" method="POST">
                    @csrf
                    <div class="mb-3">
                      <label for="kategori" class="form-label">Destinasi WIsata</label><br>
                    </div>
                    <div class="card">
                      @foreach($data['kategori'] as $kat)
                      <div class="card-body">
                        <h6 class="card-title fw-semibold mb-4">{{ $kat['nama_kategori'] }}</h6>
                        <div class="checkbox">
                          @foreach($data['wisata'] as $wis)
                          <?php if($kat['_id'] == $wis['kategori_wisata']){ ?>
                          <input type="checkbox" name="wisata[]" value="{{ $wis['_id'] }}">
                          <label >{{ $wis['nama_wisata'] }}</label><br>
                          <?php } else {} ?>
                          @endforeach
                        </div>
                      </div>
                    ...
                    <div class="mb-3">
                      <label for="harga" class="form-label">Harga Paket /pax</label>
